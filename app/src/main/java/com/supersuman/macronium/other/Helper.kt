...
val data: MutableList<Preset> = mutableListOf(Preset().also {
...
fun saveOrderedCollection(
    sharedPreferences: SharedPreferences, mutableList: MutableList<MutableList<String>>, key: String
) {
